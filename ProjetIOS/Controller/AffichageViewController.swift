...
class AffichageViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        /* Permet d'affichier la couleur des vin directement dans les casiers*/
        for p in data {
    ...
    override func viewDidLoad() {
        ...
        /* Lecture du JSON pour récuperer la varible PLACE qui correspond à l'emplacement */
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        print("Casier numéro : #\(indexPath.item)!")
    }
}
